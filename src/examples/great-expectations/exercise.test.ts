import { areFriends } from './../../lib/person';
...
describe('Kanban Board', () => {
  ...
  it('should remove a status using #removeStatus', () => {
    ...
    expect(board.statuses).not.toContain('Ready');
  });
});
...
describe('Person', () => {
  ...
  it.fails('will throw if you provide an empty string', () => {
    const fn = () => {
      new Person('');
    };
  ...
  it('will mutually add a friend', () => {
    ...
    expect(areFriends(paul, john)).toBe(true);
  });
